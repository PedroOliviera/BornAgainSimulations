...
def get_sample(num_samples):
    ...
    material_P2VP = ba.RefractiveMaterial("P2VP", 2.751436745E-06, 2.35391329E-09)
...
def main():
    ...
    save_filename = "tests_13deg_2D_cylinders.npy"
    np.save(save_filename, final_array)

    simulationDataAxes = g.get_axes_limits(result, ba.Coords_QSPACE)
    legendLabels = ["Cylinders"]
    data2D = np.load("tests_13deg_2D_cylinders.npy")
