...
def main():
    ...
    for radius in radius_P2VP:
        ...
        save_filename = "tests_13deg_line_CosineRippleGauss_P2VPradius_"+ str(radius) +"nm.npy"
    ...
    data2D = []
    for radius in radius_P2VP:
        data2D.append(np.load("tests_13deg_line_CosineRippleGauss_P2VPradius_"+ str(radius) +"nm.npy"))
