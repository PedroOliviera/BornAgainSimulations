...
exp_npz_file = "4_10deg.npz"     # saved with Q axes: [qy_min,qy_max,qz_min,qz_max]
alpha_i_deg  = 0.10
beamtime     = "feb"
...
def sample_radial_paracrystal_truncated(omega_nm=8,#6,
    ...
    material_P2VP  = ba.RefractiveMaterial("P2VP", 1.99112645E-06, 2.58315258E-09 ) # 2.49112645E-06, 2.58315258E-09
    ...
    surface_layout = ba.ParticleLayout(); 
    for i in range(num_samples):
        R = truncated_radius(height_K[i], diam_K[i]-20)
        b = 2*R - height_K[i]
