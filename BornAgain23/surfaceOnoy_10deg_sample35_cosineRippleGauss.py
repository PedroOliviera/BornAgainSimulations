...
sample = sample_radial_paracrystal_hemiellipsoid()
...
plt.savefig(r"C:\BornAgainSimulations\data\sim-npz\GISAXS_surface_0p1deg_hemiellipsoid.png", dpi=500)
plt.savefig(r"C:\BornAgainSimulations\data\sim-npz\GISAXS_surface_0p1deg_hemiellipsoid.pdf", dpi=500)
