...
if __name__ == "__main__":
    ...
    I_sim, extent_angles = run_simulation(sample, beamtime, alpha_i_deg, ROI_deg, intensity=10e11, background = 30, sim_2D = True)
    ...
    #plot_horizontal_slice_simple(alpha_cut_deg=alpha_horizontal_lincut, exp_arr=exp_arr, exp_extent=exp_axes, sim_arr=I_sim, sim_extent=extent_angles, save_fname='horizontal_S4_fitted_15deg')
    #plot_vertical_slice_simple(phi_cut_deg=phi_vertical_lincut, exp_arr=exp_arr, exp_extent=exp_axes, sim_arr=I_sim, sim_extent=extent_angles, save_fname='vertical_S4_fitted_15deg')
    ...
    ax1.set_yticks(np.arange(0, 1.80, 0.25))
    ax1.set_xticks(np.arange(-0.5, 0.55, 0.25))
    plt.savefig(r"C:\Users\Pedro\OneDrive - McMaster University\PhD - School\Research\Projects\X Ray Scattering and Diffraction\Paper\Figures\GISAXS Fits\GISAXS_interior_0p15deg_sample4.png", dpi=500)
    plt.savefig(r"C:\Users\Pedro\OneDrive - McMaster University\PhD - School\Research\Projects\X Ray Scattering and Diffraction\Paper\Figures\GISAXS Fits\GISAXS_interior_0p15deg_sample4.pdf", dpi=500)
    plt.show()