...
if __name__ == "__main__":
    ...
    I_sim, extent_angles = run_simulation(sample, beamtime, alpha_i_deg, ROI_deg, intensity=50e10, background = 30, sim_2D = True)
    ...
    ax1.set_yticks(np.arange(0, 1.80, 0.25))
    ax1.set_xticks(np.arange(-0.5, 0.55, 0.25))
    #plt.savefig(r"C:\Users\Pedro\OneDrive - McMaster University\PhD - School\Research\Projects\X Ray Scattering and Diffraction\Paper\Figures\GISAXS Fits\GISAXS_surface_0p1deg_sample4.png", dpi=500)
    #plt.savefig(r"C:\Users\Pedro\OneDrive - McMaster University\PhD - School\Research\Projects\X Ray Scattering and Diffraction\Paper\Figures\GISAXS Fits\GISAXS_surface_0p1deg_sample4.pdf", dpi=500)
    plt.show()