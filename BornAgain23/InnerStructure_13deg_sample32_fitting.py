...
def run_simulation(sample, beamtime, alpha_i_deg, ROI_deg, intensity=4e11, background = 23):
    sim = g.get_simulation_2D(
        ...
        #beamstop_deg=[-0.3, 0, 0.0633, 0.790], #0.633, 0.793
        #bounds_alpha=[0,1.75], bounds_phi=[0.0675, 1], center_horizontal_slice_values=[alpha_horizontal_lincut], center_vertical_slice_values=[phi_vertical_lincut], 
